...
import { CodeOptimizerComponent } from './features/optimizer/code-optimizer/code-optimizer.component';
...
const routes: Routes = [
  ...
  { path: 'optimizer', component: CodeOptimizerComponent, canActivate: [authGuard] },
